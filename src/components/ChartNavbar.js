...
const NavChart = ({ chartTypeHandler }) => {
  ...
  return (
    <div className="container border-stone-500 dark:bg-stone-900 dark:border-none   max-sm:m-1  flex flex-col md:flex-row justify-center md:justify-around items-center bg-white space-y-4 md:space-y-0 p-5">
      ...
      <div className="relative my-2 ">
        <select
          ...
          className=" bg-slate-50 max-sm:w-60 ml-4 h-12 rounded border font-poppins font-medium appearance-none py-2 focus:outline-none  focus:border-indigo-500 dark:bg-stone-700 text-base dark:border-none dark:text-white text-gray-600 text-bold pl-5 pr-14"
        >
