...
function PortfolioContainer() {
  ...
  return (
    <div className="dark:bg-stone-800 mb-14 pl-7 border-2 border-stone-500 dark:border-cyan-400 dark:border-0 dark:shadow-black  container shadow-lg hover:duration-300 hover:shadow-2xl bg-white mt-4 font-['Poppins'] rounded-xl p-5 w-full ">
