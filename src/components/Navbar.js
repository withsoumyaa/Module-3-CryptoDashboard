      ...
      <div className="w-full dark:bg-stone-900 max-sm:w-full  font-['Poppins'] flex justify-between my-4">
        <div className="relative">
          <select
            ...
            className="h-14 dark:border-x-cyan-400 border-2 border-stone-500 dark:border-0 dark:bg-stone-800 dark:text-white max-sm:w-26 shadow-md hover:duration-300 hover:shadow-xl bg-white rounded-xl appearance-none py-2 focus:outline-none focus:border-indigo-500 text-gray-600 text-base pl-5 pr-14"
          >
